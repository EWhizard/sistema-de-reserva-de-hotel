...
ROOT_URLCONF = 'proleap_backend.urls'
...
WSGI_APPLICATION = 'proleap_backend.wsgi.app'
...
# Update the CORS whitelist to include only your Vercel deployment
CORS_ORIGIN_WHITELIST = [
    'https://proleap.vercel.app',
]

# Keep the headers as they are
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
...
# Paths to SSL key and certificate
